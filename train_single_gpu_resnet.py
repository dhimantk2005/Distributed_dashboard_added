"""
Single-GPU CIFAR-10 training (ResNet-18 style, same metrics)
===========================================================
Usage:
  python train_single_gpu_resnet.py --epochs 1 --batch-size 64
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Single-GPU CIFAR-10 training (ResNet)")
